...
namespace GAME {
	...
	public:
		Assets_uv() {
			CHARACTERS.push_back(cge::AnimationsUV(16, 16)
			...
			CREATURES.push_back(cge::AnimationsUV(16, 16)
			...
			FLOORS.push_back(cge::AnimationsUV(16, 16)
			...
			WALLS.push_back(cge::AnimationsUV(8, 8)
				.setAnimation(std::string("default"), 0, 0, 16, 8, 1000));
			WALLS.push_back(cge::AnimationsUV(16, 8)
				.setAnimation(std::string("default"), 1, 1, 16, 8, 1000));
			WALLS.push_back(cge::AnimationsUV(16, 8)
				.setAnimation(std::string("default"), 2, 1, 16, 8, 1000));
		};

		std::vector<cge::AnimationsUV> CHARACTERS;
		std::vector<cge::AnimationsUV> CREATURES;
		std::vector<cge::AnimationsUV> FLOORS;
		std::vector<cge::AnimationsUV> WALLS;
	};
}